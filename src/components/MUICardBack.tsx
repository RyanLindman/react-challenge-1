...
interface IMUICardBack {selectedRating:number}

export default function MUICardBack(props:IMUICardBack) {
  return (
    <Box sx={{ minWidth: 275, width: "330px" }}>
      <Card sx={{ bgcolor: "#242424", padding: "20px", borderRadius: "10px" }}>
        <React.Fragment>
          ...
          >
            You gave us {props.selectedRating} out 5
          </Typography>
          <Typography
            variant="h5"
            sx={{ textAlign: "center", marginTop: "15px", color: "#FCFBF4", fontWeight:600 }}
          >
            Thank you!
          </Typography>
          <Typography
            variant="body2"
            sx={{ textAlign: "center", color: "#FCFBF4", marginTop: "6px" }}
          >
